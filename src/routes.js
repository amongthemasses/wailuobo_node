...
// -- user base --
router.get("/show/search-user-true", UserBaseController.searchUserIsTrue);
router.post("/show/diffirent-set-code", UserBaseController.diffirentSetCode);
...
router.get("/show/get-project-item", ProjectController.getProjectItem);

router.post("/setting/add-project", ProjectController.addProject);
router.post(
    "/setting/upload-image-project",
...
router.post(
    "/setting/delete-project-text",
    ProjectTextController.deleteProjectText,
);

// -- project tips --
router.post("/setting/add-project-tips", ProjectTipsController.addProjectTips);
router.post(
    "/setting/delete-project-tips",
    ProjectTipsController.deleteProjectTips,
);

// -- company --
router.get("/show/get-company", CompanyController.getCompany);
router.get("/show/get-company-item", CompanyController.getCompanyItem);
...
router.post(
    "/setting/delete-company-text",
    CompanyTextController.deleteCompanyText,
);

// -- company main --
router.post("/setting/add-company-main", CompanyMainController.addCompanyMain);
router.post(
    "/setting/delete-company-main",
    CompanyMainController.deleteCompanyMainText,
);
